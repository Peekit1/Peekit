...
export const ProjectDetails: React.FC<ExtendedProjectDetailsProps> = ({ 
  ...
  // ✅ NOUVELLE FONCTION DE FORMATAGE POUR L'AFFICHAGE
  // Transforme "2025-04-30" en "30 avril 2025"
  const formatDisplayDate = (dateString: string | undefined) => {
    if (!dateString) return '—';
    // Si la date contient déjà des lettres (ex: "30 avril"), on l'affiche telle quelle
