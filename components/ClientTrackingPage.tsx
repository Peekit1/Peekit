...
// Interface étendue pour inclure la modification du projet
...
export const ProjectDetails: React.FC<ExtendedProjectDetailsProps> = ({ 
  ...
  onUpdateCoverImage, 
  onNotifyClient,
  onUpdateProject // Nouvelle prop pour sauvegarder les infos
}) => {
  ...
  // ÉTATS POUR L'ÉDITION DES INFORMATIONS PROJET
  ...
  // Sync edited info when project changes
  useEffect(() => {
      setEditedInfo({
          clientEmail: project.clientEmail,
          date: project.date,
  ...
  // --- GESTION SAUVEGARDE INFOS PROJET ---
                      ...
                      <div className="p-6">
                          ...
                          <div className="space-y-4">
                              {isEditingInfo ? (
                                  ...
                                  <>
                                      <div className="flex items-center justify-between"><div className="flex items-center gap-2 text-gray-500"><Mail size={14} /><span className="text-xs font-medium">Email Client</span></div><span className="text-xs font-bold text-gray-900 truncate max-w-[120px]" title={project.clientEmail}>{project.clientEmail || '—'}</span></div>
