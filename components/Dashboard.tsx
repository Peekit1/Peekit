                    ...
                    <div className="max-w-5xl mx-auto space-y-10 pb-10">
                        ...
                        <div className="bg-white border border-gray-200 rounded-3xl shadow-sm overflow-hidden">
                            ...
                            <div className="divide-y divide-gray-50">
                                {[ { date: '01 Oct 2024', amount: '19.00€', status: 'Payé', ref: 'INV-003' }, { date: '01 Sept 2024', amount: '19.00€', status: 'Payé', ref: 'INV-002' }].map((inv, i) => (
                                    <div key={i} className="px-6 py-4 flex items-center justify-between hover:bg-gray-50 transition-colors"><div className="flex items-center gap-4"><div className="w-8 h-8 rounded-full bg-gray-100 flex items-center justify-center text-gray-400"><Receipt size={14}/></div><div><div className="text-sm font-bold text-gray-900">Facture #{inv.ref}</div><div className="text-xs text-gray-500">{inv.date}</div></div></div><div className="flex items-center gap-6"><div className="text-sm font-bold text-gray-900">{inv.amount}</div><div className="px-2 py-0.5 bg-emerald-50 text-emerald-600 rounded text-[10px] font-bold uppercase">{inv.status}</div><button className="text-gray-300 hover:text-black"><Download size={16}/></button></div></div>
                                ))}
                            </div>
                        </div>
                        ...
                        <div className="pt-8 flex justify-center">
                             <Button 
                                ...
                                variant="danger" 
                                className="h-10 px-8 border-red-200 text-red-600 hover:bg-red-50 hover:border-red-300 transition-all text-xs font-bold rounded-lg shadow-sm"
                             >
