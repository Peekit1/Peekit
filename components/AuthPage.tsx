        ...
        <div className="fixed inset-0 w-full h-full bg-[#F9FAFB] font-sans">
          <div className="min-h-full flex items-center justify-center p-6">
            <div className="max-w-md w-full text-center space-y-6 animate-fade-in bg-white p-8 rounded-3xl border border-gray-200 shadow-xl shadow-gray-200/50">
                ...
                <div>
                    <h2 className="text-xl font-bold text-gray-900 tracking-tight mb-2">Email envoyé</h2>
                    <p className="text-gray-500 text-sm leading-relaxed">
                        Un lien de réinitialisation a été envoyé à <br/><span className="text-gray-900 font-bold">{email}</span>.
                    </p>
                </div>
                <Button variant="outline" onClick={() => { setResetEmailSent(false); setShowResetPassword(false); setIsLogin(true); }} className="mx-auto w-full rounded-xl h-12">
