...
import { 
  ...
  ArrowDownToLine, CheckCircle2, MapPin, Calendar, LayoutGrid, Check, Flag
} from 'lucide-react';
                  ...
                  <div className="relative z-10">
                      ...
                      <div className="flex flex-wrap items-center gap-4 text-sm text-gray-400 font-medium">
                          ...
                          {project.estimatedDeliveryDate && (
                              <span className="flex items-center gap-1.5"><Flag size={14} className="text-amber-400"/> Livraison est. : {formatDate(project.estimatedDeliveryDate)}</span>
                          )}
                      </div>
                  </div>
